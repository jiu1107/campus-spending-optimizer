...
public class ConsumptionService {
    ...
    public List<Consumption> getConsumptionsByUserAndPeriod(
            Long userId, LocalDateTime startDate, LocalDateTime endDate) {
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new IllegalArgumentException("User not found"));
        return consumptionRepository.findByUserAndConsumedAtBetweenOrderByConsumedAtDesc(
    ...
    public List<CategorySummaryResponse> getCategorySummary(
        ...
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new IllegalArgumentException("User not found"));
        List<Object[]> results = consumptionRepository
                .findCategorySummaryByUserAndPeriod(user, startDate, endDate);
    ...
    // 소비 내역 수정
    @Transactional
    public void updateConsumption(Long userId, Long consumptionId, ConsumptionRequest request) {
